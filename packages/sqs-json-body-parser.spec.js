...
const sqsJsonBodyParser = require('../../src/middleware/sqs-json-body-parser');
const exampleEvent = require('../example-sqs-fifo-event.json');
...
describe('middleware/sqsJsonBodyParser >', function() {
  ...
  beforeEach(function() {
    ...
    nextStub = sinon.stub();
    event = _.cloneDeep(exampleEvent);
  });
  ...
  describe('as function >', function() {
    ...
    it('handles empty handler', function() {
      handler = null;
